...
const TICKET_TYPES = [
  { type: 'Standard', price: '35€', desc: 'Accès paddocks + expo', avail: true },
  { type: 'VIP', price: '89€', desc: 'Paddocks + zone VIP + cadeau', avail: true },
  { type: 'Baptême Pack', price: '255€', desc: 'Standard + 3 tours en LMP2', avail: false },
];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Billetterie sécurisée BDG</Text>
        </View>
        ...
        <View style={styles.ticketCard}>
          <View style={styles.ticketTop}>
            <View style={styles.ticketHeader}>
              <View>
                ...
                <Text style={styles.ticketType}>Pass Journée</Text>
              </View>
              <View style={styles.validBadge}>
                <Ionicons name="shield-checkmark" size={14} color={COLORS.success} />
                <Text style={styles.validText}>VALIDÉ</Text>
              </View>
            </View>
            ...
            <View style={styles.ticketCode}>
              ...
              <Text style={styles.codeSub}>Présentez ce QR code à l'entrée</Text>
            </View>
          </View>
          ...
          <View style={styles.ticketBottom}>
            ...
            <View>
              ...
              <Text style={[styles.metaValue, { color: COLORS.accent }]}>Standard</Text>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  ticketCard: { borderRadius: RADIUS.xxl, overflow: 'hidden', marginBottom: SPACING.lg, borderWidth: 1, borderColor: `${COLORS.primary}33`, backgroundColor: COLORS.card },
  ...
  validBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: `${COLORS.success}22`, paddingHorizontal: 12, paddingVertical: 4, borderRadius: 20 },
  validText: { fontSize: FONT_SIZES.xs, fontWeight: '800', color: COLORS.success },
  qrContainer: { backgroundColor: '#fff', borderRadius: RADIUS.lg, padding: SPACING.base, alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.base },
  qrPlaceholder: { width: 160, height: 160, alignItems: 'center', justifyContent: 'center' },
  qrNote: { fontSize: FONT_SIZES.xs, color: '#666', marginTop: 8 },
  ...
  antiFraud: { backgroundColor: `${COLORS.success}0D`, borderWidth: 1, borderColor: `${COLORS.success}33`, borderRadius: RADIUS.lg, padding: SPACING.base, flexDirection: 'row', gap: 14, alignItems: 'center', marginBottom: SPACING.lg },
